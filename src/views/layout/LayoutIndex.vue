...
import { getNoticeCount } from '@/api/friends'
...
<template>
    ...
    <div class="footer">
        <van-tabbar route inactive-color="#b8b8b8">
            ...
            <van-tabbar-item icon="chat-o" to="/message" v-if="noticeStore.noticeCount"
                :badge="noticeStore.noticeCount || null">消息</van-tabbar-item>
